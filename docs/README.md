...
| 檔案 | 內容 |
|---|---|
| [00-overview.md](00-overview.md) | **系統與啟動總覽(視覺化)** — 玩法以外的一切:架構圖、技術堆疊、存檔驅動大廳流程、跨平台啟動(Mac/Windows)、專案結構、實作進度。**新讀者從這裡開始。** |
| [10-rulebook-zh.md](10-rulebook-zh.md) | **遊戲規則書(繁中)** — 玩家導向的完整玩法規則:設置、四階段、技能檢定/混沌袋、行動百科、敵人關鍵字、戰役、牌組構築、詞彙表。 |
| [01-game-rules.md](01-game-rules.md) | **規則與玩法整理(建模視角)** — 遊戲組成、回合結構、技能檢定、混沌袋、戰鬥/調查、戰役系統、牌組構築。電子化時的規則抽象化重點。 |
